...
export default function Navbar() {
    return (
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center mx-auto p-4 justify-between md:justify-normal">
                <Link href="/" className="flex items-center">
                    <Image 
                        ...
                        height="33"
                    />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FWA</span>
                </Link>
                ...
                <div class="hidden w-full md:block md:w-auto ml-8" id="navbar-default">
